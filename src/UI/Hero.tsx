...
function Hero() {
  return (
    <main className="md:max-w-screen-2xl px-14 md:px-2 md:flex items-center justify-between mx-auto">
      ...
      <img
        src={hero}
        alt="hero-image"
        className="mt-16 block mx-auto h-96 w-96 lg:h-[720px] lg:w-[680px]"
      />
    </main>
  );
}
